...
// Force this route to be dynamic to avoid static params generation
// which can fail during build due to runtime-only dependencies
...
const DocumentIdPage = ({ params }: DocumentIdPageProps) => {
  ...
  const Editor = useMemo(
    () => dynamicImport(() => import("@/components/editor"), { ssr: false }),
    []
  );
